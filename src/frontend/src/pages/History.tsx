...
function EntryRow({ entry, index, onDelete, isDeleting }: EntryRowProps) {
  ...
  return (
    <TableRow
      ...
      data-ocid={`history.row.${ocidIndex}`}
    >
      <TableCell className="font-medium text-foreground text-sm py-4">
        {formatDate(entry.date)}
      </TableCell>
      <TableCell className="text-sm text-foreground/80 py-4">
          ...
          <AlertDialogContent className="bg-card border-border">
            <AlertDialogHeader>
              ...
              <AlertDialogDescription className="text-muted-foreground">
                ...
                ? This action cannot be undone and will update all summary
                statistics.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
        ...
        <div className="rounded-xl border border-border bg-card shadow-card overflow-hidden">
          ...
          <div className="divide-y divide-border">
            {["sk1", "sk2", "sk3", "sk4", "sk5"].map((sk) => (
              <div key={sk} className="flex items-center gap-4 p-4">
          ...
          {sortedEntries.length === 0 ? (
            ...
            >
              ...
              <p className="text-muted-foreground text-sm max-w-xs">
                Head to the Dashboard to record your first investment entry and
